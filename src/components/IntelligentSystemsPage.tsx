    ...
    <div className="pt-20">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-8 sm:pt-0">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-12 text-center">
          ...
          >
            <span className="relative z-10 flex items-center gap-5 sm:gap-4">
      ...
      <section className="relative py-24 sm:py-32 lg:py-56 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            >
              <span className="group-hover:text-[#41E0FF] transition-colors duration-300 flex items-center justify-center gap-5 sm:gap-5">
