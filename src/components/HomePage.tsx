      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-8 sm:pt-0">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-12 flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            >
              <span className="group-hover:text-[#41E0FF] transition-colors duration-300 flex items-center justify-center gap-3 sm:gap-2">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <button
              ...
              className="mt-12 sm:mt-8 group flex items-center gap-3 sm:gap-2 text-[#41E0FF] hover:text-[#5AE0FF] transition-colors"
            >
