      ...
      <section className="relative py-32 px-6 lg:px-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <motion.button
            ...
            className="group relative px-12 py-5 bg-gradient-to-r from-[#8B5CF6] to-[#5AE0FF] rounded-lg overflow-hidden transition-all duration-300 hover:scale-105"
          ...
          >
            <span className="relative z-10 flex items-center gap-2">
              Explore Research Opportunities <ArrowRight className="w-5 h-5" />
            </span>
