      ...
      <section className="relative py-32 px-6 lg:px-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <motion.button
            ...
            className="group relative px-12 py-5 bg-gradient-to-r from-[#5AE0FF] to-[#41E0FF] rounded-lg overflow-hidden transition-all duration-300 hover:scale-105"
          ...
          >
            <span className="relative z-10 flex items-center gap-2">
              Build Your Automation Layer <ArrowRight className="w-5 h-5" />
            </span>

            <motion.div
              className="absolute inset-0 bg-gradient-to-r from-[#41E0FF] to-[#5AE0FF]"
              animate={{
                scale: [1, 1.5, 1],
                opacity: [0, 0.5, 0],
              }}
