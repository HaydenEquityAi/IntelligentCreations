      ...
      <section className="relative py-56 px-12 lg:px-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <motion.button
            ...
            className="group relative px-24 py-8 bg-gradient-to-r from-[#5AE0FF] to-[#41E0FF] rounded-lg overflow-hidden transition-all duration-300 hover:scale-105 text-xl font-medium"
